...
public class GameActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View controlsView = findViewById(R.id.game_content_controls);
        final View contentView = findViewById(R.id.game_content);
        ...
        findViewById(R.id.button_response).setOnTouchListener(mDelayHideTouchListener);
